  ...
  <div class="tab-content">
   <div class="tab-pane" id="students_tab">
        ...
        <div class="panel-body">
          <div class="row">
            ...
            <div class="col-sm-6">
              ...
              <h5>Student No: 13345678</h5>
			  <h5>Lecture Section: 201</h5>
              <h5>Lab Section: L1B</h5>
            </div>
          </div>
          <div class="row">
            <table class="grades table table-bordered col-sm-4">
	...
	<div class="alyssa col-sm-10" id="john">
      <div class="panel panel-primary">
        <div class="panel-heading">
          <h3 class="panel-title">Leung, John</h3>
        </div>
        <div class="panel-body">
          <div class="row">
            <div class="col-sm-2">
            ...
            <div class="col-sm-6">
              ...
              <h5>Student No: 13746670</h5>
			  <h5>Lecture Section: 201</h5>
              <h5>Lab Section: L1E</h5>
            </div>
          </div>
          <div class="row">
            <table class="grades table table-bordered col-sm-4">
...
>>>>>>> newbranch
      <div class="panel panel-primary">
        <div class="panel-heading">
          <h3 class="panel-title">Leung, Phoa</h3>
        </div>
        <div class="panel-body">
          <div class="row">
            <div class="col-sm-2">
...
>>>>>>> parent of 7ab7abd... Added SQL support
